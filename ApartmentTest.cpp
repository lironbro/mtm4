...
bool apartmentTestFirst(){
	...
	ASSERT_THROW(Apartment::IllegalArgException, Apartment(squares, -1,
			width, price));
	ASSERT_THROW(Apartment::IllegalArgException, Apartment(squares, length,
			-1, price));
	ASSERT_THROW(Apartment::IllegalArgException, Apartment(squares, length,
			width, -1));
	ASSERT_THROW(Apartment::IllegalArgException, Apartment(NULL, length,
			width, price));
	ASSERT_NO_THROW(Apartment(squares, length, width, price));
	/*
	 * apt:
	...
	ASSERT_THROW(Apartment::OutOfApartmentBoundsException,apt(7,1));
	ASSERT_THROW(Apartment::OutOfApartmentBoundsException,apt(1,8));
