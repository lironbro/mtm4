...
private:
	...
	void subscribeToTopic(const Subscriber& sub, const Topic& t);

	void unsubscribeToTopic(const Subscriber& sub, const Topic& t);

	void publishTopic(const Publisher& pub, const Topic& t);

	void unpublishTopic(const Publisher& pub, const Topic& t);

	void publishMessage(const Topic& t, const std::string& message,
